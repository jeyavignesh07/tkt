...
class UpdateTktPage extends StatefulWidget {
  const UpdateTktPage({super.key});

  @override
  State<UpdateTktPage> createState() => _UpdateTktPageState();
}

class _UpdateTktPageState extends State<UpdateTktPage> {
  late String empId;
  late String lTktNo;
  ...
  Future getRaisedByUserList() async {
    var data = await TktDb.instance.getRaisedByUserList('A');
    if (data.length > 0) {
      userList = data;
      setState(() {});
    }
